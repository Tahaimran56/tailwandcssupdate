  ...
  return (
    <div className="max-w-3xl mx-auto p-6 font-sans bg-slate-600">
      <nav className="mb-4 p-3 bg-gray-800">
        <a
          href="#home"
          className="text-white font-bold mx-3 line-through hover:text-blue-200"
        >
          Home
        </a>
        <a
      ...
      <section id="home" className="mb-10 p-5 bg-gray-400">
        <h1 className="text-2xl font-bold italic mb-3 text-gray-800">
          Welcome to My Site
        </h1>
        ...
        <p className="text-lg text-gray-800 leading-6">
          Hello, I am Taha Qureshi. I have expertise in web development and UI
          design.
        </p>
      </section>
      ...
      <section id="about" className="mb-10 p-5 bg-gray-400 text-center">
        ...
        <p>
          Currently working at a distribution company managing their website.
        </p>
        <p>Also working on my own projects.</p>
        <p>
          Currently i am student at <b>giaic</b>
        </p>
      ...
      <section id="contact" className="mb-10 p-5 bg-white text-center">
        ...
        <p>
          {" "}
          <i> If you need any help, feel free to contact me -</i>{" "}
        </p>
        <div className="my-4">
      ...
      <section
        id="sociallink"
        className="flex justify-center mt-6 space-x-4 text-gray-800 font-bold"
      >
        <a
          href="https://www.instagram.com/723_taha?igsh=N254aGVsZ24yeGFn"
        ...
        <a
          href="https://github.com/Tahaimran56"
          className="hover:text-blue-400"
        >
          GitHub
        </a>
        <a
          href="https://www.linkedin.com/in/taha-khan-37a5792a6/"
          className="hover:text-blue-400"
        >
          LinkedIn
        </a>
